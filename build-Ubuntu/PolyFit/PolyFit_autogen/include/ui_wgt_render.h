...
public:
    ...
    void setupUi(QWidget *WidgetRender)
    {
        if (WidgetRender->objectName().isEmpty())
            WidgetRender->setObjectName(QStringLiteral("WidgetRender"));
        ...
        widgetScalarRender->setObjectName(QStringLiteral("widgetScalarRender"));
        ...
        labelPointSet->setObjectName(QStringLiteral("labelPointSet"));
        ...
        checkBoxPointSet->setObjectName(QStringLiteral("checkBoxPointSet"));
        ...
        toolButtonPointSetColor->setObjectName(QStringLiteral("toolButtonPointSetColor"));
        ...
        doubleSpinBoxVerticesSize->setObjectName(QStringLiteral("doubleSpinBoxVerticesSize"));
        ...
        doubleSpinBoxVerticesSize->setMinimum(0.1);
        doubleSpinBoxVerticesSize->setMaximum(50);
        doubleSpinBoxVerticesSize->setSingleStep(1);
        doubleSpinBoxVerticesSize->setValue(3);
        ...
        labelSegments->setObjectName(QStringLiteral("labelSegments"));
        ...
        checkBoxSegments->setObjectName(QStringLiteral("checkBoxSegments"));
        ...
        doubleSpinBoxSegmentVerticesSize->setObjectName(QStringLiteral("doubleSpinBoxSegmentVerticesSize"));
        ...
        doubleSpinBoxSegmentVerticesSize->setMinimum(0.1);
        doubleSpinBoxSegmentVerticesSize->setMaximum(50);
        doubleSpinBoxSegmentVerticesSize->setSingleStep(1);
        doubleSpinBoxSegmentVerticesSize->setValue(3);
        ...
        labelUseColorAttribute->setObjectName(QStringLiteral("labelUseColorAttribute"));
        ...
        checkBoxPerPointColor->setObjectName(QStringLiteral("checkBoxPerPointColor"));
        ...
        widgetPlainRender->setObjectName(QStringLiteral("widgetPlainRender"));
        ...
        labelUseColorAttr->setObjectName(QStringLiteral("labelUseColorAttr"));
        ...
        checkBoxSharpEdges->setObjectName(QStringLiteral("checkBoxSharpEdges"));
        ...
        checkBoxPerFaceColor->setObjectName(QStringLiteral("checkBoxPerFaceColor"));
        ...
        toolButtonSharpEdgesColor->setObjectName(QStringLiteral("toolButtonSharpEdgesColor"));
        ...
        doubleSpinBoxSharpEdgesWidth->setObjectName(QStringLiteral("doubleSpinBoxSharpEdgesWidth"));
        ...
        doubleSpinBoxSharpEdgesWidth->setMinimum(0.1);
        doubleSpinBoxSharpEdgesWidth->setMaximum(10);
        doubleSpinBoxSharpEdgesWidth->setValue(1);
        ...
        labelSurface->setObjectName(QStringLiteral("labelSurface"));
        ...
        toolButtonSurfaceColor->setObjectName(QStringLiteral("toolButtonSurfaceColor"));
        ...
        labelSharpEdges->setObjectName(QStringLiteral("labelSharpEdges"));
    ...
    {
        WidgetRender->setWindowTitle(QApplication::translate("WidgetRender", "Render", Q_NULLPTR));
        groupBox_2->setTitle(QApplication::translate("WidgetRender", "Point Cloud", Q_NULLPTR));
        labelPointSet->setText(QApplication::translate("WidgetRender", "Point Set", Q_NULLPTR));
        checkBoxPointSet->setText(QString());
        toolButtonPointSetColor->setText(QApplication::translate("WidgetRender", "...", Q_NULLPTR));
        labelSegments->setText(QApplication::translate("WidgetRender", "Segments", Q_NULLPTR));
        checkBoxSegments->setText(QString());
        labelUseColorAttribute->setText(QApplication::translate("WidgetRender", "Per-point Color", Q_NULLPTR));
        checkBoxPerPointColor->setText(QString());
        groupBox->setTitle(QApplication::translate("WidgetRender", "Mesh", Q_NULLPTR));
        labelUseColorAttr->setText(QApplication::translate("WidgetRender", "Per-face Color", Q_NULLPTR));
        checkBoxSharpEdges->setText(QString());
        checkBoxPerFaceColor->setText(QString());
        toolButtonSharpEdgesColor->setText(QApplication::translate("WidgetRender", "...", Q_NULLPTR));
        checkBoxSurface->setText(QString());
        labelSurface->setText(QApplication::translate("WidgetRender", "Surface", Q_NULLPTR));
        toolButtonSurfaceColor->setText(QApplication::translate("WidgetRender", "...", Q_NULLPTR));
        labelSharpEdges->setText(QApplication::translate("WidgetRender", "Sharp Edges", Q_NULLPTR));
    } // retranslateUi
