...
void WeightPanelClick::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<WeightPanelClick *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (WeightPanelClick::*)();
...
QT_INIT_METAOBJECT const QMetaObject WeightPanelClick::staticMetaObject = { {
    &QDialog::staticMetaObject,
    qt_meta_stringdata_WeightPanelClick.data,
    qt_meta_data_WeightPanelClick,
    qt_static_metacall,
    nullptr,
    nullptr
} };
